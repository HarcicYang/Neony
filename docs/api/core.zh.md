...
> [English version](core.en.md) · [API 索引](README.zh.md) · [文档首页](../README.zh.md)
...
[`SharedSignal`](reactive.zh.md#sharedsignal) 之外跨窗口数据的命令式方案。
...
[`Video` / `Audio`](components.zh.md#video)）。播放期间整个文件驻留
